...
public class LoanApplication implements Serializable {
    ...
    public String toString() {
        return "customerName=" + customerName + ", income=" + income + ", requestedAmount=" + requestedAmount + ", creditCheckOk=" + creditCheckOk + ", explanation=" + explanation + ", emailAddress=" + emailAddress + '}';
    }
